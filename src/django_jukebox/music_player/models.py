...
from django_jukebox.music_player.managers import SongRequestManager
...
class SongRequest(models.Model):
    ...
    the queue.
    """
    song = models.ForeignKey('music_db.Song', on_delete=models.CASCADE)
...
def songrequest_pre_save(sender, instance, *args, **kwargs):
    ...
    more simple.
    """
    if instance.song.rating is None or \
